  ...
  <ul>
    <li>Prevents a single compromise from exposing everything.</li>
    <li>Makes it harder to link separate roles or campaigns.</li>
    <li>Supports safer experimentation and learning.</li>
  </ul>
</section>
...
<section>
  ...
  <ul>
    ...
    <li>Use consistent naming to avoid mixing devices by mistake.</li>
  </ul>
</section>
