...
<section>
  <h2>🔍 1. What Investigators Look At</h2>
  <ul>
    <li>Device images: full copies of storage for later analysis.</li>
    <li>System and app logs, cached data and databases.</li>
    <li>Backups and synced copies held by cloud providers.</li>
  </ul>
</section>

<section>
  <h2>❌ 2. Common Misconceptions</h2>
  <ul>
    <li>“Incognito mode” removes traces everywhere – it does not.</li>
    <li>Deleting an app guarantees its data is gone – it may not.</li>
    <li>
      Tools marketed as “erasers” often focus on peace of mind, not proven
      guarantees.
    </li>
  </ul>
</section>
