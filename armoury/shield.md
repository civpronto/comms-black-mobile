...
- Improved sandboxing & isolation beyond standard Android.
...
- Timely OS updates & device support.
- App compatibility via alternative stores or optional sandboxed Google Play.
- Duress PIN/Password: irreversible wipe (incl. encryption keys & installed eSIMs) and power-off.
