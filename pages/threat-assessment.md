...
This assessment is designed to map your **real‑world situation** to the **right kit**, without asking for your name, email, or any identifying details.
...
<div class="ta-note">
  <p><em>Your answers are processed in your browser. In future iterations, more of your responses (like adversary type and impact) will be used to further customise the explanation, but the core kit recommendation already follows the logic we designed.</em></p>
</div>

## Your results

<div id="ta-result" class="ta-result">
  <p><em>Fill out at least the first few questions above and click “Get my recommendation” to see your result here.</em></p>
</div>
