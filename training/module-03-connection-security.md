    ...
    <section>
  <h2>1. VPN: Capabilities, Mitigations, Limitations</h2>
  <ul>
    <li><strong>Capabilities:</strong> Encrypts traffic between you and the VPN exit.</li>
    <li><strong>Mitigations:</strong> Hides traffic from local Wi-Fi/ISP, merges you into a pool of users.</li>
...
<section>
  <h2>2. Tor: Capabilities, Mitigations, Limitations</h2>
  <ul>
...
<section>
  ...
  <ul>
    <li>Telcos see tower location, call/SMS metadata, SIM identifiers.</li>
    <li>Anonymous SIMs reduce direct identity linkage but not location.</li>
    <li>Best used with strict compartmentalisation and limited lifespan.</li>
  </ul>
</section>
...
<section>
  ...
  <p>
    Think of fingerprinting as a "chart" of your unique browser/device traits:
  </p>
  <ul>
    <li>Screen size, fonts, language, time zone and installed features.</li>
